        ...
        <div className="container mx-auto h-full flex items-center xl:items-start">
            ...
            <motion.div className=" flex flex-col justify-center items-center gap-6 text-center fixed left-0 right-0 mt-24 xl:mt-[160px] "     
                ...
                <p className="max-w-[680px] text-[20px] text-white/80 font-light px-8 xl:px-0 mb-2">
                    Streamline tasks and manage your time effortlessly with our powerful, intuitive, all in one productivity platform.
                </p>
                <Button btnText="Join today"/>
            </motion.div>
            {/* image div */}
            <motion.div className="hidden xl:flex w-full max-w-[960px] mx-auto h-[520px] bg-no-repeat sticky left-0 right-o"
                 style={{

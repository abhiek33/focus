...
const featuresData = [
    {
        ...
        description: "Organise and prioritise tasks efforlessly. ",
        highlights: [
    ...
    },
    {
        ...
        description: "Personalise your workspace for maximum efficiency.",
        highlights: [
            "Set due dates and reminders.",
            "Track progress and milestones.",
            "Easily sort tasks by priority.",
            ...
            <div className="flex gap-16">
                ...
                >
                    <div className="relative w-full h-full">
                        <Image src={featuresData[imgIndex].imgSrc} alt="" fill className="h-full object-contain" />
                    </div>
                </motion.div>
                {/* ............text.................... */}
